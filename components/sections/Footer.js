...
export const Footer = () => {
  ...
  return (
    <footer className='p-10 rounded footer footer-center bg-base-200 text-base-content'>
      ...
      <div>
        <p>Copyright © {year} | EngelDelgado - FullStack Developer </p>
      </div>
    </footer>
  )
}
