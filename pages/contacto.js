                ...
                <div className='px-6 py-10 text-center bg-white sm:px-10 lg:col-span-2 xl:p-12 dark:bg-gray-900'>
                  ...
                  <div className='flex items-center justify-center pb-5'>
                    <div className='flex-shrink-0'>
                      <Image className='w-32 h-32 rounded-full' src='/imagenes/profile-pic.png' alt='Engelbert Vizcaya' width={128} height={128} />
                    </div>
                  </div>
                  <h3 className='text-xl font-medium text-center text-warm-gray-900'>Agenda una cita conmigo ahora</h3>
                  <p className='w-11/12 pt-5 mx-auto mt-1 text-sm text-center text-warm-gray-500'>
                  ...
                  <PopupButton
                    ...
                    className='inline-flex items-center justify-center px-5 py-3 mt-8 text-base font-medium text-white border border-transparent rounded-md shadow-sm bg-primary hover:bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary'
                    rootElement={rootEl}
                  />
                </div>
              </div>
